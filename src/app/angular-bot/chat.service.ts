...
export class ChatService {
  ...
  messageMap = {
    ...
    "I am having cold as well": "Stay hydrated. Water, juice, clear broth or warm lemon water with honey helps loosen congestion and prevents dehydration.",
    "I am having a Fever": "Elderflowers, catnip (gentle choice for children), yarrow, white willow bark, Echinacea, and lemon balm are all known to assist in the treatment of fevers. Lemon juice and raw honey can be added to the tea for an extra boost of vitamin C (but never give honey to a child under one year of age",
